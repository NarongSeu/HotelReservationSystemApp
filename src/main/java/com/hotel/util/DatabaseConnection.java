...
public class DatabaseConnection {
    ...
    // Load credentials from db.properties at class load time
    static {
            ...
            if (input == null) {
                throw new ExceptionInInitializerError(
                        "db.properties not found in classpath. " +
                                "Copy db.properties.example to src/main/resources/db.properties and fill in your credentials."
                );
            }
    ...
    private static void testConnectionAvailability() {
        try {
            ...
            System.err.println("2. Database credentials are correct in db.properties");
            System.err.println("3. MySQL is accessible on the configured host/port");
            connectionAvailable = false;
        }
